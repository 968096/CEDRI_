...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HEATERPROFILE._serialized_start=384
  _HEATERPROFILE._serialized_end=495
  _SENSORGPSREADING._serialized_start=29
  _SENSORGPSREADING._serialized_end=382
